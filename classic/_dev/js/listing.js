...
$(document).ready(() => {
  ...
  $(
    prestashop.themeSelectors.listing.searchFilterControls +
      " " +
      prestashop.themeSelectors.clear
  ).on("click", function () {
  ...
  $("body").on("click", prestashop.themeSelectors.listing.searchLink, function (
    event
  ) {
  ...
  window.addEventListener("popstate", function (e) {
    ...
    window.location.href =
      state && state.current_url ? state.current_url : history;
  });
