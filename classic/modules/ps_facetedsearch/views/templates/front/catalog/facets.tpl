    ...
    {if $displayedFacets|count}
        <div id="search_filters">
            {* {if $listing.products|count}
                {hook h='displayOrderBy' listing=$listing}
            {/if} *}
            ...
            <div class="test">
                {foreach from=$displayedFacets item="facet"}
                    {if $facet@iteration eq 2}<div id="filters-container">{/if}
                        <section {if $facet.label=='Categories' } class="facet clearfix col-md-12" {else} class="facet clearfix" {/if} id="{$facet.label}">
                    ...
                    <ul id="facet_{$facet.label}" {if $facet.label=='Categories' } class="collapse{if !$_collapse} in{/if} col-md-9" {else} class="collapse{if !$_collapse} in{/if}" {/if}>
                        {if $facet.label == 'Categories'}
                        <li>
                            <label class="facet-label">
                                <a href="{url entity='category' id=2}" class=" _gray-darker search-link js-search-link" rel="nofollow">All</a>
                            </label>
                        </li>
                        {/if}
                    ...
                    <div class="button-container col-md-3">
                        <a id="filter" href="#" {* onclick="handleOpenFilters() " *}> Filter
                            <span class=" material-icons">add</span>
                        </a>
                        <a id="filter-card" href="#" {* onclick="handleOpenFilters() " *}>
                            <span class=" material-icons">view_module</span>
                        </a>
                        <a id="filter-list" href="#" {* onclick="handleOpenFilters() " *}>
