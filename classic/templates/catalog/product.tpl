    ...
    *}
    ...
    <section id="main" itemscope itemtype="https://schema.org/Product">
        ...
        <div class="row product-container">
            ...
            <div id="summury_container" class="col-md-4">
                ...
                <div class="product-information">
                    ...
                    <div id="product-description-short-{$product.id}" class="product-description" itemprop="description">{$product.description_short nofilter}
                    </div>
                </div>
                {/block}
            ...
            <div class="container-tabs">
                <div class="tabs">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        {/if}
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#shipping" role="tab" aria-controls="shipping">{l s='Shipping' d='Shop.Theme.Catalog'}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="tab-pane fade in{if $product.description} active{/if}" id="description" role="tabpanel">
                            ...
                            <div class="product-description">
                                ...
                                <div class="product-cover">
                                    ...
                                    <img class="js-qv-product-cover" src="{$product.default_image.bySize.large_default.url}" {if !empty($product.default_image.legend)} alt="{$product.default_image.legend}" title="{$product.default_image.legend}" {else} alt="{$product.name}" {/if} itemprop="image" loading="lazy">
                                </div>
                                {else}
                            ...
                            <div class="product_features">
                                <div class="product-cover-features">
                                    {if $product.default_image}
                                    <img class="js-qv-product-cover" src="{$product.default_image.bySize.large_default.url}" {if !empty($product.default_image.legend)} alt="{$product.default_image.legend}" title="{$product.default_image.legend}" {else} alt="{$product.name}" {/if} itemprop="image" loading="lazy">
                                    {else}
                                    <img src="{$urls.no_picture_image.bySize.large_default.url}" style="width:100%;" loading="lazy">
