            ...
            {block name='order_confirmation_table'}
                {foreach from=$products item=product}
                    <div class="order-line row">
                        <div class="col-sm-2 col-xs-3 col-md-6">
                            <div class="order-line-inner">
                                <span class="image">
                                    {if $product.cover}
                        ...
                        <div class="col-sm-6 col-md-6 col-xs-12 qty">
                            <div class="row">
                                <div class="col-xs-4 col-md-4 text-sm-center text-xs-left">{$product.price}</div>
                                <div class="col-xs-4 col-md-4 text-sm-center">{$product.quantity}</div>
                                <div class="col-xs-4 col-md-4 text-sm-center text-xs-right">{$product.total}</div>
                            </div>
                        </div>
                    </div>
                {/foreach}
