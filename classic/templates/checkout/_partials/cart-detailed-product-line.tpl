...
* @author PrestaShop SA and Contributors <contact@prestashop.com>
    ...
    *}
    <div class="product-line-grid">
        ...
        <div class="product-line-grid-left col-md-6 col-xs-7">
        ...
        <div class="product-line-grid-body col-md-1 col-xs-7">
        ...
        <div class="col-md-2 col-xs-6 qty">
            {if !empty($product.is_gift)}
            <span class="gift-quantity">{$product.quantity}</span>
            {else}
            <input class="js-cart-line-product-quantity" data-down-url="{$product.down_quantity_url}" data-up-url="{$product.up_quantity_url}" data-update-url="{$product.update_quantity_url}" data-product-id="{$product.id_product}" type="number" value="{$product.quantity}" name="product-quantity-spin" />
            {/if}
        </div>
        <!--  product line right content: actions (quantity, delete), price -->
        <div class="product-line-grid-right product-line-actions col-md-1 col-xs-12">
            <div class="row">
        ...
        <div class="product-line-grid-remove col-md-1 col-xs-1 text-xs-right">
