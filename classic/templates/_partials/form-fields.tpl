...
* @author PrestaShop SA and Contributors <contact@prestashop.com>
    ...
    *}
    ...
    <div class="form-group row col-md-12 {if !empty($field.errors)}has-error{/if}">
        ...
        <div class="col-md-12{if ($field.type === 'radio-buttons')} form-control-valign{/if}">
            ...
            <div class="input-group js-parent-focus">
                <input class="form-control js-child-focus js-visible-password" name="{$field.name}" title="{l s='At least 5 characters long' d='Shop.Forms.Help'}" type="password" value="" pattern=".{literal}{{/literal}5,{literal}}{/literal}" {if $field.required}required{/if}>
